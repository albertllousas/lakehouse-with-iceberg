...
object UserClickBuilder {
    ...
    fun create(
        ...
        latitude: String = "lat",//faker.address().latitude(),
        longitude: String = "long",//faker.address().longitude(),
        country: String = "es",//faker.country().countryCode2(),
        time: LocalDateTime = LocalDateTime.now(),
        ip_address: String = "ipaddress",//faker.internet().ipV4Address(),
        city: String = "barcelona",//faker.address().city(),
        os: String = "mac",//faker.options().option("IOS 17", "Android 13.0.0_r67", "Chrome 114"),
        device_model: String = "Web"//, faker.options().option("Iphone", "Android", "Web"),
    ) = UserClick(
